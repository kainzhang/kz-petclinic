...
<div class="content-search">
    <div class="content-search-pane">
        <form action="OwnerServlet?method=searchOwners&pageIndex=1" method="post">
            <a href="OwnerServlet?method=toInsertOwner">ADD NEW</a>
...
<div class="content-picshow">
    <c:forEach items="${list}" var="item">
        <a href="OwnerServlet?method=showOwner&id=${item.id}" class="content-picshow-item">
